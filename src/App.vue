...
<style lang="postcss" scoped>
  main {
    ...
    .title{
    @apply m-2 text-6xl font-light tracking-wider text-yellowish;
    }
    form {
      @apply mt-8 flex focus-within:ring-8 focus-within:ring-accent focus-within:rounded-lg;
      input{
        @apply bg-white text-comment p-2 w-80 text-2xl rounded-l-md;
      }
      button {
    ...
    ul {
      ...
      li{
        @apply bg-bluish text-background m-2 p-2 w-96 text-center;
        &:hover {
